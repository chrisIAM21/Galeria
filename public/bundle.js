...
const cargarImagen = (id, nombre, ruta, descripcion) => {
    ...
    // Marcamos la imagen minuatura del carousel como activa:
    if (galeria$4.querySelectorAll('.galeria__carousel-slide').length > 0){
        // Eliminamos la clase activa de la imagen miniatura del carousel para que no se quede activa en caso de activar otra.
...
/// Funcion para cargar la siguiente o anterior imagen de la principal
...
contenedorCategorias.addEventListener('click',(e) => {
    ...
    if(e.target.closest('a')){/// Busca que sea el objetivo más cercano con una etiqueta html tipo "a".
...
const carousel = (direccion) => {
    ...
    const observer = new IntersectionObserver((entradas) => {
        ...
        const slides = galeria$1.querySelectorAll('.galeria__carousel-image');
